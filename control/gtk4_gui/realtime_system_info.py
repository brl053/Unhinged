    ...
    def _process_process_updates(self, process_data: dict[int, Any]):
        ...
        try:
            ...
            for pid in existing_pids:
                ...
                if (
                    abs(current_proc.cpu_percent - last_proc.cpu_percent) > 1.0
                    or abs(current_proc.memory_percent - last_proc.memory_percent) > 1.0
                ):
    ...
    def _process_bluetooth_updates(self, bluetooth_data: dict[str, Any]):
        ...
        try:
            ...
            for address in existing_addresses:
                ...
                if (
                    current_device.connected != last_device.connected
                    or current_device.paired != last_device.paired
                    or current_device.trusted != last_device.trusted
                    or current_device.blocked != last_device.blocked
                ):
