...
try:
    from .config import service_config, app_config, ServiceEndpoint
    from .exceptions import (
        ServiceUnavailableError, ServiceTimeoutError, ServiceResponseError,
        AudioTranscriptionError, handle_grpc_error, AudioFileSizeError
    )
except ImportError:
...
class ServiceRegistry:
    ...
    def discover_service(self, service_name: str, port_range: Optional[List[int]] = None) -> Optional[ServiceEndpoint]:
    ...
    def get_preferred_endpoint(self, service_name: str) -> Optional[ServiceEndpoint]:
