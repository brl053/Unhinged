...
@kotlin.jvm.JvmName("-initializelistDocumentVersionsResponse")
public inline fun listDocumentVersionsResponse(block: unhinged.document_store.ListDocumentVersionsResponseKt.Dsl.() -> kotlin.Unit): unhinged.document_store.DocumentStore.ListDocumentVersionsResponse =
  unhinged.document_store.ListDocumentVersionsResponseKt.Dsl._create(unhinged.document_store.DocumentStore.ListDocumentVersionsResponse.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `unhinged.document_store.ListDocumentVersionsResponse`
 */
public object ListDocumentVersionsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: unhinged.document_store.DocumentStore.ListDocumentVersionsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: unhinged.document_store.DocumentStore.ListDocumentVersionsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): unhinged.document_store.DocumentStore.ListDocumentVersionsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun unhinged.document_store.DocumentStore.ListDocumentVersionsResponse.copy(block: `unhinged.document_store`.ListDocumentVersionsResponseKt.Dsl.() -> kotlin.Unit): unhinged.document_store.DocumentStore.ListDocumentVersionsResponse =
  `unhinged.document_store`.ListDocumentVersionsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val unhinged.document_store.DocumentStore.ListDocumentVersionsResponseOrBuilder.nextPaginationTokenOrNull: com.google.protobuf.Timestamp?
