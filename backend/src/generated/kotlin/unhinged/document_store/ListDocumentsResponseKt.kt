...
public inline fun listDocumentsResponse(block: unhinged.document_store.ListDocumentsResponseKt.Dsl.() -> kotlin.Unit): unhinged.document_store.DocumentStore.ListDocumentsResponse =
  unhinged.document_store.ListDocumentsResponseKt.Dsl._create(unhinged.document_store.DocumentStore.ListDocumentsResponse.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `unhinged.document_store.ListDocumentsResponse`
 */
public object ListDocumentsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: unhinged.document_store.DocumentStore.ListDocumentsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: unhinged.document_store.DocumentStore.ListDocumentsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): unhinged.document_store.DocumentStore.ListDocumentsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun unhinged.document_store.DocumentStore.ListDocumentsResponse.copy(block: `unhinged.document_store`.ListDocumentsResponseKt.Dsl.() -> kotlin.Unit): unhinged.document_store.DocumentStore.ListDocumentsResponse =
  `unhinged.document_store`.ListDocumentsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val unhinged.document_store.DocumentStore.ListDocumentsResponseOrBuilder.nextPaginationTokenOrNull: com.google.protobuf.Timestamp?
