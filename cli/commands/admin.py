...
def list():
    ...
    subprocess.run([python_cmd, "libs/python/service_framework/service_launcher.py", "--list"])
...
def health():
    ...
    python_cmd = get_python()
    subprocess.run([python_cmd, "libs/python/service_framework/service_launcher.py", "--status"])
