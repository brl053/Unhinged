...
class LlmDocsEvolutionEngine:
    ...
    def _should_skip_file(self, file_path: Path) -> bool:
        ...
        skip_patterns = [".git/", "__pycache__/", "node_modules/", ".llmdocs-backup/", "generated/"]
    ...
    def _transform_legacy_to_evolved(self, legacy_doc: LegacyLlmDoc, file_path: Path) -> EvolvedLlmDoc:
        ...
        return EvolvedLlmDoc(type=evolved_type, does=evolved_does, rule=evolved_rule)
    ...
    def _extract_critical_rule(self, axiom: str) -> str | None:
    ...
    def _format_evolved_block(self, evolved_doc: EvolvedLlmDoc, file_extension: str) -> str:
        ...
        lines = [f"@llm-type {evolved_doc.type}", f"@llm-does {evolved_doc.does}"]
