...
from .plugin_interface import BuilderPlugin, PluginCapability, FilePattern, PluginMetadata
...
class PluginRegistry:
    ...
    def _load_plugin_from_file(self, py_file: Path) -> Optional[Type[BuilderPlugin]]:
        ...
        for name, obj in inspect.getmembers(module, inspect.isclass):
            if (issubclass(obj, BuilderPlugin) and 
                obj != BuilderPlugin and 
    ...
    def get_plugin(self, name: str) -> Optional[BuilderPlugin]:
        """Get plugin by name."""
    ...
    def get_best_plugin_for_files(self, file_paths: List[Path]) -> Optional[BuilderPlugin]:
        """
