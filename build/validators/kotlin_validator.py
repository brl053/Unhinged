...
class KotlinValidator(BaseValidator):
    ...
    async def _validate_gradle_content(
        self, gradle_file: Path, results: list[ValidationResult], severity: str = "WARNING"
    ):
        ...
        try:
            ...
            version_patterns = [r'version\s*=\s*["\'][\d.]+["\']', r'implementation\s*["\'][^:]+:[\d.]+["\']']
