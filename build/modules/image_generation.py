...
class SovereignImageGenerator:
    ...
    def __init__(self, config: ImageGenerationConfig | None = None):
        ...
        self.generation_stats = {"total_generations": 0, "total_time": 0.0, "average_time": 0.0, "cache_hits": 0}

        self.logger.info("🎨 Initialized SovereignImageGenerator")
        ...
        try:
            ...
            if "xl" in model_name.lower():
                ...
                self.pipe = DiffusionPipeline.from_pretrained(
                    model_name, torch_dtype=self.config.dtype, use_safetensors=True, cache_dir=self.config.cache_dir
                )
    ...
    def save_result(self, result: GenerationResult, output_dir: Path, filename_prefix: str = "generated") -> list[Path]:
        """
