...
def main():
    ...
    parser.add_argument("command", choices=["overview", "paginate"], help="Command to execute")
    ...
    parser.add_argument(
        "--comments-file", default="docs/architecture/extracted-comments.json", help="Path to extracted comments file"
    )
