...
class ProjectAnalyzer:
    def __init__(self, root_path: str = "."):
        ...
        self.ignore_files = {".DS_Store", "Thumbs.db", "*.log", "*.tmp"}
        ...
        for root, dirs, files in os.walk(self.root_path):
            ...
            for file in files:
                if file in important_files:
                    ...
                    key_files.append({"path": rel_path, "name": file, "purpose": important_files[file]})
    ...
    def _analyze_service(self, service_path: Path) -> dict:
        ...
        service_info["has_tests"] = any((service_path / test_dir).exists() for test_dir in test_indicators)
    ...
    def _analyze_components(self) -> dict:
        ...
        for comp_name, comp_desc in component_dirs.items():
            ...
            if comp_path.exists():
                ...
                components[comp_name] = {"description": comp_desc, "exists": False}
