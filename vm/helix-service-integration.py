...
HELIX_SERVICE_CONFIG = {
    "windows_bf6_vm": {
        ...
        "command": [
            ...
            "-device", "vfio-pci,host=01:00.0",  # NVIDIA RTX 4090
            "-drive", "file=/home/e-bliss-station-1/Projects/Unhinged/vm/bf6-w11-gaming.qcow2,if=virtio,format=qcow2,cache=writeback",
            "-netdev", "user,id=net0",
