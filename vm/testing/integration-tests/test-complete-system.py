...
class UnhingedSystemTest:
    ...
    def test_prerequisites(self):
        ...
        tests = [
            ...
            ("Graphics library built", "test -f libs/graphics/build/libunhinged_graphics.so"),
            ("Alpine ISO downloaded", "test -f vm/alpine/alpine-virt-3.22.2-x86_64.iso"),
            ("Python wrapper created", "test -f libs/graphics/python/unhinged_graphics.py")
        ]
    ...
    def test_alpine_vm_creation(self):
        ...
        if vm_disk.exists():
            ...
            result = self.run_command("python3 -c \"from control.qemu_vm_launcher import QEMULauncher; q = QEMULauncher(); q.create_alpine_vm_disk()\"")
