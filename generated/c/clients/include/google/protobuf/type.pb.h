...
constexpr Syntax Syntax_MAX = SYNTAX_EDITIONS;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Type::set_edition(ArgT0&& arg0, ArgT... args) {
...
inline void Type::set_allocated_edition(std::string* edition) {
  if (edition != nullptr) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Enum::set_edition(ArgT0&& arg0, ArgT... args) {
...
inline void Enum::set_allocated_edition(std::string* edition) {
  if (edition != nullptr) {
