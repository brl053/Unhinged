...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 13, -1, -1, sizeof(::PROTOBUF_NAMESPACE_ID::Field)},
  { 29, -1, -1, sizeof(::PROTOBUF_NAMESPACE_ID::Enum)},
  { 41, -1, -1, sizeof(::PROTOBUF_NAMESPACE_ID::EnumValue)},
  { 50, -1, -1, sizeof(::PROTOBUF_NAMESPACE_ID::Option)},
};
...
const ::_pbi::DescriptorTable descriptor_table_google_2fprotobuf_2ftype_2eproto = {
    false, false, 1647, descriptor_table_protodef_google_2fprotobuf_2ftype_2eproto,
...
uint8_t* Type::_InternalSerialize(
  ...
  if (!this->_internal_edition().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "google.protobuf.Type.edition");
    target = stream->WriteStringMaybeAliased(
        7, this->_internal_edition(), target);
  }
...
uint8_t* Enum::_InternalSerialize(
  ...
  if (!this->_internal_edition().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_edition().data(), static_cast<int>(this->_internal_edition().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "google.protobuf.Enum.edition");
    target = stream->WriteStringMaybeAliased(
        6, this->_internal_edition(), target);
  }
