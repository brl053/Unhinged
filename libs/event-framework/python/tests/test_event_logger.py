...
from events import EventLogger, EventLoggerConfig, LogLevel, OutputFormat, create_logger, create_service_logger
...
class TestEventLogger:
    ...
    def test_log_level_filtering(self):
        ...
        config = EventLoggerConfig(service_id="test-service", min_log_level=LogLevel.WARN)
        logger = create_logger(config)
    ...
    def test_yaml_output_format(self):
        ...
        config = EventLoggerConfig(
            service_id="test-service", output_format=OutputFormat.YAML, min_log_level=LogLevel.DEBUG
        )
        logger = create_logger(config)
    ...
    def test_json_output_format(self):
        ...
        config = EventLoggerConfig(
            service_id="test-service", output_format=OutputFormat.JSON, min_log_level=LogLevel.DEBUG
        )
        logger = create_logger(config)
    ...
    def test_all_log_levels(self):
        ...
        config = EventLoggerConfig(service_id="test-service", min_log_level=LogLevel.DEBUG)
        logger = create_logger(config)
