...
class DefaultEventLogger(EventLogger):
    ...
    def _emit_event(self, level: LogLevel, message: str, metadata: Dict[str, Any], 
...
def create_service_logger(service_id: str, version: str = "1.0.0", 
                         environment: str = "development",
                         min_log_level: LogLevel = LogLevel.INFO) -> EventLogger:
