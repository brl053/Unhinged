"""
Prompt Renderer - Re-exported from scription.

This module provides backward compatibility by re-exporting from the canonical
location in /scription/orchestration/lib/prompt_orchestration.
"""
...
from prompt_orchestration.render import UnhingedPromptRenderer

__all__ = ["UnhingedPromptRenderer"]
