...
class ServiceClient:
    ...
    def call_with_timeout(self, method_name: str, request, timeout: Optional[float] = None) -> Any:
        """
    ...
    def stream_with_timeout(self, method_name: str, request, timeout: Optional[float] = None):
        """
...
def register_service(name: str, address: str, stub_class: Optional[Type] = None,
